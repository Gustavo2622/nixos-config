{
  ...
  home.file."./.config/wezterm/wezterm.lua".text = ''
    -- Config from Drew @justaguylinux small mods
     ...
     config.font_size = ${toString vars.termFontSize}
     config.font = wezterm.font("${vars.fontName}", { weight = "Regular", italic = false })
     ...
     config.window_frame = {
       ...
       font = wezterm.font({ family = "${vars.uiFontName}", weight = "Regular" }),
     }
