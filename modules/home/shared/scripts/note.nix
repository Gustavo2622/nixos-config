# Full-featured note manager storing notes in ~/.local/share/notes/notes.txt with
# numbering and timestamps; supports add, display, delete-by-number, clear, and pipe input.
{pkgs, ...}:
