  ...
  wayland.windowManager.hyprland = {
    settings = {
      windowrule = [
        ...
        "no_blur on, match:class ^(\bresolve\b)$, match:xwayland 1" # Window rule for just resolve
        ...
        # qs-cheatsheets floating viewer (dedicated size)
        ...
        # qs-keybinds, qs-docs floating viewer
        "float on, match:title ^(Hyprland Keybinds|Niri Keybinds|BSPWM Keybinds|i3 Keybinds|Sway Keybinds|DWM Keybinds|Emacs Leader Keybinds|Kitty Configuration|WezTerm Configuration|Ghostty Configuration|Yazi Configuration|Documentation Viewer|Keybind Cheatsheet)$"
        "center on, match:title ^(Hyprland Keybinds|Niri Keybinds|BSPWM Keybinds|i3 Keybinds|Sway Keybinds|DWM Keybinds|Emacs Leader Keybinds|Kitty Configuration|WezTerm Configuration|Ghostty Configuration|Yazi Configuration|Documentation Viewer|Keybind Cheatsheet)$"
        "size 55% 66%, match:title ^(Hyprland Keybinds|Niri Keybinds|BSPWM Keybinds|i3 Keybinds|Sway Keybinds|DWM Keybinds|Emacs Leader Keybinds|Kitty Configuration|WezTerm Configuration|Ghostty Configuration|Yazi Configuration|Documentation Viewer|Keybind Cheatsheet)$"
