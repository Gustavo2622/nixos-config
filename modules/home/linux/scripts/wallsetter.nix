# Randomly rotates wallpapers every 720 seconds using swww with a random transition;
# prevents repeating the same image and requires more than one image in the directory.
{pkgs, ...}:
