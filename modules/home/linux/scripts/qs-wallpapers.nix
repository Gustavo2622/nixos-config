# QuickShell/QML static wallpaper picker; builds ImageMagick thumbnails cached in
# ~/.cache/wallthumbs, displays a searchable grid, outputs SELECT: for the apply script.
{pkgs}:
