# QuickShell/QML keybindings viewer supporting multiple app modes (hyprland, kitty,
# ghostty, yazi, etc.); uses keybinds-parser and renders a searchable, color-coded grid.
{pkgs}:
