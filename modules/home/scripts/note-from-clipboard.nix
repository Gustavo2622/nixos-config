# Reads clipboard contents via wl-paste, checks MIME type, and creates a new note
# via the note script if text; shows a libnotify notification on success or failure.
{pkgs, ...}:
