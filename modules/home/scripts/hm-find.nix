# Scans journalctl for home-manager activation errors, identifies .bck conflict files,
# and prompts for deletion with confirmation; logs all operations to ~/hm-logs.
{pkgs}:
