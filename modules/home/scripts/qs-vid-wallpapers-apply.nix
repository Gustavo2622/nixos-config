# Applies a video wallpaper using mpvpaper (loop, optional audio); kills conflicting
# daemons and saves current state to ~/.local/state/qs-wallpapers/current.json.
{pkgs}:
