# QuickShell/QML video wallpaper picker; scans ~/Pictures/Wallpapers for video files,
# generates thumbnails via ffmpegthumbnailer, tracks mpvpaper status, and toggles audio.
{pkgs}:
