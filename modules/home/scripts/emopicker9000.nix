# Rofi-based emoji picker that copies the selection to clipboard via wl-copy or types it
# via ydotool; reads emoji list from ~/.config/.emoji; shows a libnotify notification on copy.
{pkgs}:
