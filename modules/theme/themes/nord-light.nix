# Nord Light (Snow Storm) — base16 color scheme (light)
# Required attributes: base00–base0F (hex without #), wallpaper
{
  base00 = "eceff4"; # background
  base01 = "e5e9f0"; # lighter background
  base02 = "d8dee9"; # selection
  base03 = "4c566a"; # comments
  base04 = "434c5e"; # dark foreground
  base05 = "3b4252"; # foreground
  ...
  base0F = "5e81ac"; # dark red
  wallpaper = ../../../Wallpapers/PinkPurpleHaze.jpg;
}
